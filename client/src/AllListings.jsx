    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[80vh]">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.pexels.com/photos/3288100/pexels-photo-3288100.png')",
          }}
        >
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center text-white px-6">
          <div className="max-w-4xl">
            <p className="text-sm tracking-[0.3em] mb-4 uppercase font-light">
            ...
            <p className="text-lg md:text-xl max-w-2xl mx-auto font-light leading-relaxed opacity-90">
              Browse our curated collection of luxury properties or contact us
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredListings.map((listing, idx) => {
            ...
            if (
              ...
              console.warn(
                "Listing missing image, using placeholder:",
                idValue
              );
            }
            return (
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    />
                    <span
                      className={`absolute top-4 right-4 ${statusBadge.color} text-white text-xs font-medium px-4 py-2 tracking-[0.2em]`}
                    >
                      {statusBadge.text}
                    </span>
                  </div>
                ...
                <div className="py-6">
                  ...
                  <p className="text-3xl font-serif text-gray-900 mb-6">
                    ${listing.price}
                  </p>
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center text-white px-6">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl max-w-2xl mx-auto font-light leading-relaxed mb-10">
              I love real estate. I strive to share this passion with my clients
              and will use my wealth of experience to help you realize your own
              dreams for your home, family and asset growth.
            </p>
            <button
              type="button"
              onClick={() =>
